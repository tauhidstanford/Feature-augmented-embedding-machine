...
% is of 0 mean and unit variance, whereas the other component is of 0.5
% mean and 4 variance.

num_class=2; % Number of class in the data
M=3000;  % Number of points in each class
N=60;
groundTruth = [ones(1,M) 2*ones(1,M)];

A(1:M,1:N) = 0.5+2*randn(M,N); 
